...
class DyCausalNode(BsNode):
    ...
    def doSplit(self, covariateNames, treatmentName, outcomeName, weightName, maxTreeDepth, minSize, alpha, train_to_est_ratio, criteria=None):
        ...
        for cov in covariateNames:
            ...
            for val in unique_vals:
                ...
                #covXr = rightData[covariateNames].to_numpy()
                ...
                #covXl = leftData[covariateNames].to_numpy()
    ...
    def boxEstimate(self, candidates, epsilon):
        ...
        #dupEpsilon = np.tile(epsilon, (candidates.shape[0], 1))
...
class DyCausalTree(BsTree):
    ...
    def constructTree(self):
        ...
        #covX = self.dataset[self.covariateNames].to_numpy()  
    ...
    def __MapMotivation (self, inval ):
        ...
        return motivationTypeDict[MOTIVATION]
